...
// Leaderboard sort helpers were moved to `src/lib/leaderboard-sort.ts` —
// this file carries the `'use server'` directive which forbids non-async
// exports, so the synchronous sort/rank functions cannot live here.

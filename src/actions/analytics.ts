...
//
// Pure TypeScript sort comparators for the People directory leaderboard.
// Exported so tests can import and verify sort behavior directly.
// Callers: people/page.tsx RSC (sorts already-fetched arrays — no new SQL).
//
// T-09-05-T: sortBy is mapped through a fixed option allowlist; unrecognised values
// fall through to the default (approved / turnaround) — never SQL-interpolated.

...
- **D-80 [Claude's Discretion]:** For 3-role parity, surface a link to the existing office-engineer activity scorecard (PERF-03, Phase 7) alongside the worker/auditor scorecards. Do not rebuild PERF-03.
